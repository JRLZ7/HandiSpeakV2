                    ...
                    for video_id, video_data in data.items():
                        for frame in video_data:
                            ...
                            if keypoint_length == 360:
                                print(f"🚨 Problematic Video: {video_id} in file {file_name} has {keypoint_length} keypoints")
...
# Run the script for both train and val directories
